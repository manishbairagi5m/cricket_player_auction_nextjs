...
const QF = ({tournamentData,team}) => {
  ...
  const saveFixture = async (data) => {
    ...
    let postData = {...data ,date:data.date+':00', tournament_stages: 'QF',tournament_id:router.query.id}
 ...
 const getFixtureData = async () => {
  const params = {tournament_id:router.query.id, tournament_stages:'QF'}
