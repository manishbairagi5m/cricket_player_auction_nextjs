...
const Final = ({tournamentData,team}) => {
  ...
  const saveFixture = async (data) => {
    ...
    let postData = {...data ,date:data.date+':00', tournament_stages: 'FINAL',tournament_id: router.query.id}
 ...
 const getFixtureData = async () => {
   const params = {tournament_id:router.query.id, tournament_stages:'FINAL'}
